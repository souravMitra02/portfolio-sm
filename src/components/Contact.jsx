...
const Contact = () => {
  return (
    <section
      ...
      >
           <h2 className="text-3xl font-bold text-center text-white mb-8">Let's Get in Touch</h2>
      <div
        data-aos="fade-up"
        ...
        <div className="bg-[#212428] p-6 rounded-lg shadow-[16px_16px_20px_#0f1012,_-10px_-10px_60px_#292e34] flex flex-col justify-between">
          ...
          <div>
            ...
            <p className="mb-5 text-center">
             "I'm open to job opportunities and freelance work — feel free to reach out anytime via call, email, or WhatsApp."
            </p>
  ...
  <div className="space-y-3 text-sm text-center sm:text-left w-full sm:w-[50%]">
    ...
    <p className="flex items-center justify-center sm:justify-start gap-2">
      <MdAttachEmail size={20} /> <strong>Email:</strong> inf.souravmitra@gmail.com
    </p>
    <p className="flex items-center justify-center sm:justify-start gap-2">
      <MapPinHouse size={20} /> <strong>Address:</strong> Barishal, Dhaka, Bangladesh.
    </p>
  </div>
  ...
  <div className="text-sm text-center sm:text-left w-full sm:w-[45%]">
    <p>
      <span className="text-red-500 font-bold">Available 24/7</span> — For urgent queries, feel free to call or WhatsApp me anytime.
    </p>
